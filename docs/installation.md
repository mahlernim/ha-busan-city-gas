...
CNCITY에너지·경남에너지·서라벌도시가스·지에스이는 아래 고급 연결 절차를 사용합니다. 이 브랜치에서 추가한 귀뚜라미·미래엔서해·참빛 지역별 **(에너지톡)** 항목도 같은 절차를 사용하며, 추가 항목은 차기 릴리스부터 설치할 수 있습니다. 기존 가스앱 연결은 그대로 사용할 수 있습니다.
